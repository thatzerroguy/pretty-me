  ...
  return (
    <header className="relative w-full h-[80vh] md:h-[85vh] overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl animate-fade-in-up">
        <span className="text-white text-xs md:text-sm tracking-[0.4em] uppercase mb-4 block font-medium opacity-90">The Winter Collection</span>
        <h1 className="font-display text-5xl md:text-8xl text-white mb-10 drop-shadow-2xl leading-[1.1]">Elegance <br className="md:hidden" /> Redefined</h1>
